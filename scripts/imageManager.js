...
let backgroundImages = {
  ...
  Miles:
    "https://raw.githubusercontent.com/JacobMckenna/theamazingspiderguy.invitecard.com/main/images/miles_background.jpg",
};

let textboxImages = {
  // from textbox image name to image src link
  Basic:
    "https://raw.githubusercontent.com/JacobMckenna/theamazingspiderguy.invitecard.com/main/images/invite_textbox.png",
};
  ...
  function loadImages(bgImageSrc, textboxImageSrc) {
    ...
    Promise.all([loadImage(bgImageSrc), loadImage(textboxImageSrc)])
      .then(([bgImage, textboxImage]) => {
        ...
        ctx.drawImage(textboxImage, 0, 0, canvas.width, canvas.height/2); // textbox image
        drawText(
          nameText.value,
